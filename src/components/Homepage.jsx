...
const Homepage = () => {
  ...
  return (
    <>
        ...
        <Row>
            <Col span={12}><Statistic title='Total Crypto Currencies' value={globalStats.total} />
            </Col>
            ...
            <Col span={12}><Statistic title='Total 24h Vlume' value={millify(globalStats.total24hVolume)} />
            </Col>
